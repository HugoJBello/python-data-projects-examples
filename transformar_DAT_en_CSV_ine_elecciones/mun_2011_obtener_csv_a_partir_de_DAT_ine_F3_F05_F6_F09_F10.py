...
def romper_cadenas_datos(datos_txt,lista_longitudes_y_descrip):
    ...
    for linea in datos_txt_lineas:
        ...
        contador = contador +1
        print("procesando línea " + str(contador) + " de " + str(longitud) , end="\r")
