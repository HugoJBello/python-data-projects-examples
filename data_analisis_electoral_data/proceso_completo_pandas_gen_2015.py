...
df_f05 = pd.read_csv("recursos_input/gen_2015/F05_1_GEN_2015.csv",sep=";",error_bad_lines=False, encoding="utf-8")
df_f03 = pd.read_csv("recursos_input/gen_2015/F03_GEN_2015.csv",sep=";",error_bad_lines=False, encoding="utf-8")
df_f10 = pd.read_csv("recursos_input/gen_2015/F10_GEN_2015.csv",sep=";",error_bad_lines=False, encoding="utf-8")
df_f10.loc[:, df_f10.columns != "MESA"].astype(int)
...
nombres_municipios = ["Madrid", "Móstoles", "Alcalá de Henares", 
							...
							"Rozas de Madrid (Las)", "San Sebastián de los Reyes",
...
for n_mun in nombres_municipios:
    cod_municipio = df_f05.loc[df_f05['MUNICIPIO'] == n_mun.upper()]['COD_MUN'].values.tolist()[0]
    cod_ccaa = df_f05.loc[df_f05['MUNICIPIO'] == n_mun.upper()]['COD_CCAA'].values.tolist()[0]
    cod_prov = df_f05.loc[df_f05['MUNICIPIO'] == n_mun.upper()]['COD_PROV'].values.tolist()[0]
    ...
    dir_salida = "tmp"
    nombre_subfichero_salida = n_mun + "_F10_GEN_2015_denom_cand_agrupado_ruben_pc.csv"
