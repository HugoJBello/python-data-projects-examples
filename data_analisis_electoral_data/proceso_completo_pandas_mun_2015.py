...
df_f05 = pd.read_csv("recursos_input/mun_2015/F05_1_MUN_2015.csv",sep=";",error_bad_lines=False, encoding="utf-8")
df_f03 = pd.read_csv("recursos_input/mun_2015/F03_MUN_2015.csv",sep=";",error_bad_lines=False, encoding="utf-8")
df_f10 = pd.read_csv("recursos_input/mun_2015/F10_MUN_2015.csv",sep=";",error_bad_lines=False, encoding="utf-8")
