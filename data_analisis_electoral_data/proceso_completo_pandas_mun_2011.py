...
df_f05 = pd.read_csv("recursos_input/mun_2011/F05_1_MUN_2011.csv",sep=";",error_bad_lines=False, encoding="utf-8")
df_f03 = pd.read_csv("recursos_input/mun_2011/F03_MUN_2011.csv",sep=";",error_bad_lines=False, encoding="utf-8")
df_f10 = pd.read_csv("recursos_input/mun_2011/F10_MUN_2011.csv",sep=";",error_bad_lines=False, encoding="utf-8")
...
for n_mun in nombres_municipios:
    ...
    dir_salida = "tmp"
    nombre_subfichero_salida = n_mun + "_F10_MUN_2011_denom_cand_agrupado_ruben_pc.csv"
